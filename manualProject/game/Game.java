...
public class Game {
     ...
     *
     * @param specifyAIStatus - Boolean that signifies whether the game will implement Player vs
     ...
     * specification
     *
     * @param player1Board Board object that stores all of the information of the main
     *                     player's board
     * @param player2Board Board object that stores all of the information of the main
     *                     player's board
     ...
     * @param currentPlayer - Current player's board
     */
