...
public class SetupPhase {
     ...
     *
     * @param wordLen - length of ship in string format
     * @param shipLenCount - amount of ships allowed at given length
     * @param len - length of ship
     *
     * @return section - a VBox layout of a section of a ship length
     */
